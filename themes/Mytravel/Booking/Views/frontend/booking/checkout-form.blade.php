        ...
        <div class="pt-4 pb-5 px-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 mb-4">
                    ...
                    <input type="text" class="form-control" value="{{$user->state ?? ''}}" name="state" placeholder="{{__("Flight Time")}}">
                </div>
                <div class="col-sm-6 mb-4">
                    <label class="form-label">
                        {{ __("Flight Code") }}
                    </label>
                    <input type="text" class="form-control" value="{{$user->zip_code ?? ''}}" name="zip_code" placeholder="{{__("Flight Code")}}">
                </div>
