...
<a href="mailto:contact@mytravel.com"></a>',
                    'group' => "general",
                ],
                [
    ...
    <div class="mb-5 mr-md-7 mr-lg-0">
        <h4 class="h6 mb-4 font-weight-bold">deneme yazısı</h4>
        ...
        <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item mr-2">
                ...
                [
                    ...
                    'val'   => '© 2022 MyTravel. All rights reserved',
                    'group' => "general",
                ],
                [
