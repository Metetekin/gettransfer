        ...
        mounted(){
            ...
            var options = {
                ...
                locale:{
                    ...
                    firstDay:datetime-local.first_day_of_week
                },
            ...
            if (typeof  datetime-local == 'object') {
                options.locale = _.merge(datetime-local,options.locale);
            }

            this.$nextTick(function () {

                $(this.$refs.start_date).datetime-local(options).on('apply.datetime-local',
                    function (ev, picker) {
        ...
        methods:{
            ...
            fetchEvents(start,end){
                ...
                $.ajax({
                    ...
                    data:data,
                    beforeSend: function() {
                        $('.datetime-local').addClass("loading");
                    },
                    success:function (json) {
                        me.allEvents = json;
                        var drp = $(me.$refs.start_date).data('datetime-local');
                        drp.allEvents = json;
                        drp.renderCalendar('left');
                        if (!drp.singleDatePicker) {
                            drp.renderCalendar('right');
                        }
                        $('.datetime-local').removeClass("loading");
                    },
                    error:function (e) {
                        console.log(e);
