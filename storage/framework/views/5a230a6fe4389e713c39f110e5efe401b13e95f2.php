    ...
    <div class="mb-5 shadow-soft bg-white rounded-sm">
        <div class="pt-4 pb-5 px-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 mb-4">
                    <label class="form-label">
                        <?php echo e(__("Flight Time")); ?>

                    </label>
                    <input type="text" class="form-control" value="<?php echo e($user->state ?? ''); ?>" name="state" placeholder="<?php echo e(__("Flight Time")); ?>">
                </div>
                <div class="col-sm-6 mb-4">
                    <label class="form-label">
                        <?php echo e(__("Flight Code")); ?>

                    </label>
                    <input type="text" class="form-control" value="<?php echo e($user->zip_code ?? ''); ?>" name="zip_code" placeholder="<?php echo e(__("Flight Code")); ?>">
                </div>
...
<?php /**PATH /home/gett5822/public_html/themes/Mytravel/Booking/Views/frontend/booking/checkout-form.blade.php ENDPATH**/ ?>