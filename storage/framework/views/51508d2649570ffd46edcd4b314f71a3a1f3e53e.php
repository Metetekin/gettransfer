        ...
        <div id="bravo_car_book_app" class="bravo_single_book " v-cloak>
            <div class="border border-color-7 rounded mb-5">
                ...
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        <span class="d-block text-gray-1 font-weight-normal mb-0 text-left"><?php echo e(__("Date")); ?></span>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <div class="border-bottom border-width-2 border-color-1 pb-3">
                                <div class="flex-center-between mb-1 text-dark font-weight-bold">
                                    <span class="d-block">
                                        <?php echo e(__('Car')); ?> <br>
                                    </span>
                                    <div class="flex-horizontal-center">
                                        <a class="font-size-10 text-dark" href="javascript:;" @click="minusNumberType">
                                            <i class="fa fa-chevron-down"></i>
                                        </a>
                                        <input class="form-control h-auto width-30 font-weight-bold font-size-16 shadow-none bg-tranparent border-0 rounded p-0 mx-1 text-center"  type="text"  v-model="number" min="4" max="1">
...
<?php /**PATH /home/gett5822/public_html/themes/Mytravel/Car/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>