                ...
                <div class="card-body px-4 pt-0">
                    <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                        ...
                        <?php if(!empty($price_item)): ?>
                            <li class="d-flex justify-content-between py-2">
                                <div class="label"><?php echo e(__('Price')); ?>
            ...
            <div class="modal-body">
                <ul class="review-list list-unstyled">
                    <li class="mb-3 pb-1 border-bottom">
                        ...
                        <div>
                            <?php if ($__env->exists("Boat::frontend.booking.detail-date",['rows'=>$dateDetail,'number'=>$booking->number])) echo $__env->make("Boat::frontend.booking.detail-date",['rows'=>$dateDetail,'number'=>$booking->number], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<?php /**PATH /home/gett5822/public_html/themes/Mytravel/Boat/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>