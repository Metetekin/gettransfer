            ...
            <div class="mb-0">
                <div class="input-group border-bottom border-width-2 border-color-1">
                    ...
                    <div class="smart-search border-0 p-0 form-control  height-40">
                        <input type="text" class="smart-select parent_text form-control font-weight-bold" readonly placeholder="<?php echo e(__(":name",['name'=>$attr_translate->name])); ?>" value="<?php echo e($selected ? $selected->name ?? '' :''); ?>" data-default="<?php echo e(json_encode($list_cat_json)); ?>">
...
<?php /**PATH /home/gett5822/public_html/themes/Mytravel/Car/Views/frontend/layouts/search-map/fields/attr.blade.php ENDPATH**/ ?>