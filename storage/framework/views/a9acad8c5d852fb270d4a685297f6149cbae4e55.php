<tr>
    ...
    <td width="2%">
        ...
        <?php if(!empty(setting_item("car_allow_vendor_can_change_their_booking_status"))): ?>
            ...
            <div class="dropdown-menu">
                <?php if(!empty($statues)): ?>
                    <?php $__currentLoopData = $statues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route("car.vendor.booking_report.bulk_edit" , ['id'=>$booking->id , 'status'=>$status])); ?>">
        ...
        <?php endif; ?>
            <?php if(!empty(setting_item("car_allow_vendor_can_change_paid_amount"))): ?>
...
<?php /**PATH /home/gett5822/public_html/themes/Mytravel/Car/Views/frontend/bookingReport/loop.blade.php ENDPATH**/ ?>