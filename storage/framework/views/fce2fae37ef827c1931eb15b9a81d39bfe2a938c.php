<?php if(!empty($field['attr']) and !empty($attr = \Modules\Core\Models\Attributes::find($field['attr']))): ?>
            ...
            <div class="mb-4">
                <div class="input-group border-bottom border-width-2 border-color-1 py-2">
                    ...
                    <div class="smart-search border-0 p-0 form-control  height-40">
                        <input type="text" class="smart-select font-weight-bold parent_text form-control" readonly placeholder="<?php echo e(__("All :name",['name'=>$attr_translate->name])); ?>" value="<?php echo e($selected ? $selected->name ?? '' :''); ?>" data-default="<?php echo e(json_encode($list_cat_json)); ?>">
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/gett5822/public_html/themes/Mytravel/Tour/Views/frontend/layouts/search/fields/attr.blade.php ENDPATH**/ ?>