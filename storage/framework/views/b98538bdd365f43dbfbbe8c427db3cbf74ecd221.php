<aside class="sidebar-right">
    ...
    <?php if($list_sidebars): ?>
        ...
        <?php $__currentLoopData = $list_sidebars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make('Car::frontend.layouts.sidebars.'.$item->type, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
</aside><?php /**PATH /home/gett5822/deneme/themes/Mytravel/Car/Views/frontend/layouts/details/news-sidebar.blade.php ENDPATH**/ ?>