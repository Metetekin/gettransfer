            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" name="price_per_day" class="form-control" value="<?php echo e($row->price_per_day); ?>" placeholder="<?php echo e(__("Price")); ?>">
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH /home/gett5822/public_html/modules/Boat/Views/admin/boat/pricing.blade.php ENDPATH**/ ?>